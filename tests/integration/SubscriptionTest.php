...
class SubscriptionTest extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Paymill\Lib\Models\Request\Subscription
     */
    private $_model;
    ...
    public function createSubscription()
    {
        ...
        $this->assertInstanceOf('Paymill\Lib\Models\Response\Offer', $OfferModelResponse, var_export($OfferModelResponse, true));
        ...
        $this->assertInstanceOf('Paymill\Lib\Models\Response\Payment', $PaymentModelResponse, var_export($PaymentModelResponse, true));
        ...
        $this->assertInstanceOf('Paymill\Lib\Models\Response\Subscription', $result, var_export($result, true));
    ...
    {
        $this->_model->setId($model->getId());
        $this->assertInstanceOf('Paymill\Lib\Models\Response\Subscription', $result = $this->_service->getOne($this->_model), var_export($result, true));
